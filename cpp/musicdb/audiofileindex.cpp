...
Shared::MusicDatabase* get_music_db() {
  ...
  */
  ...
  Shared::Song oo1 = {.path =
                          "O/One Day as a Lion - 2008 - One Day as a Lion/01 - "
                          "Wild International.mp3",
                      ...
                      .secondaryIds = {},
                      .variations = {}};
  Shared::Song oo2 = {.path =
                          "O/One Day as a Lion - 2008 - One Day as a Lion/02 - "
                          "Ocean View.mp3",
                      ...
                      .secondaryIds = {},
                      .variations = {}};
  Shared::Song oo3 = {.path =
                          "O/One Day as a Lion - 2008 - One Day as a Lion/03 - "
                          "Last Letter.mp3",
                      ...
                      .secondaryIds = {},
                      .variations = {}};
  Shared::Song oo4 = {.path =
                          "O/One Day as a Lion - 2008 - One Day as a Lion/04 - "
                          "If You Fear Dying.mp3",
                      ...
                      .secondaryIds = {},
                      .variations = {}};
  Shared::Song oo5 = {.path =
                          "O/One Day as a Lion - 2008 - One Day as a Lion/05 - "
  ...
  Shared::Song cb1 = {
      .path =
          "C/CHVRCHES/2013 - The Bones of What You Believe/01 - "
          "The Mother We Share.flac",
  ...
  Shared::Song cb2 = {
      .path =
          "C/CHVRCHES/2013 - The Bones of What You Believe/02 - "
          "We Sink.flac",
  ...
  Shared::Song cb3 = {
      .path =
          "C/CHVRCHES/2013 - The Bones of What You Believe/03 - "
          "Gun.flac",
  ...
  Shared::Song cb4 = {
      .path =
          "C/CHVRCHES/2013 - The Bones of What You Believe/04 - "
          "Tether.flac",
  ...
  Shared::Song cb5 = {
      .path =
          "C/CHVRCHES/2013 - The Bones of What You Believe/05 - "
          "Lies.flac",
      ...
      .variations = {}};
  Shared::Song ce1 = {
      .path = "C/CHVRCHES/2015 - Every Open Eye/01 - Never Ending Circles.flac",
      ...
      .secondaryIds = {},
      .variations = {}};
  Shared::Song ce2 = {.path =
                          "C/CHVRCHES/2015 - Every Open Eye/02 - "
                          "Leave a Trace.flac",
                      ...
                      .secondaryIds = {},
                      .variations = {}};
  Shared::Song ce3 = {.path =
                          "C/CHVRCHES/2015 - Every Open Eye/03 - "
                          "Keep You On My Side.flac",
                      ...
                      .secondaryIds = {},
                      .variations = {}};
  Shared::Song ce4 = {.path =
                          "C/CHVRCHES/2015 - Every Open Eye/04 - "
                          "Make Them Gold.flac",
  ...
  /* Shared::Song song = {
        ...
        .track = 1,
        .disk = 1,
        .vaType = Shared::VAType::Compilation,
        .originalPath = root / "example.mp3"};
        */
  return music_db = db;
}
